...
gulp.task('sass', function(){ // Создаем таск Sass
	return gulp.src('app/assets/sass/**/*.scss') // Берем источник
...
gulp.task('watch', ['browser-sync', 'css-libs', 'scripts'], function() {
	gulp.watch('app/assets/sass/**/*.scss', ['sass']); // Наблюдение за sass файлами в папке sass
	gulp.watch('app/assets/*.html', browserSync.reload); // Наблюдение за HTML файлами в корне проекта
...
gulp.task('build', ['clean', 'img', 'sass', 'scripts'], function() {
	...
	var buildHtml = gulp.src('app/assets/*.html') // Переносим HTML в продакшен
	.pipe(gulp.dest('dist'));
